describe('order view', function(){
    ...
    // it('live orders', function(){ 
        ...
        //  cy.get('td').contains('Postpaid')
        //  cy.get('[class="btn-group mr-2"]')
        // cy.xpath('//*[@id="app"]/div/div/div[2]/main/div[2]/div/table/tbody/tr[1]/td[10]/div/a[1]').click().wait(3000)
        // cy.xpath('//*[@id="app"]/div/div/div[2]/main/div[2]/div/table/tbody/tr[3]/td[10]/div/a[1]').click()
        // cy.viewport(2999, 2999).wait(3000)
